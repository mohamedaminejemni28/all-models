...
DATASET_PREFIX = "flatfoot_control_older_2024"
DATASET_NAME = "Flatfoot Control Older 2024"
GROUP_MAPPING = "Control=0, Flatfoot=1"
...
EXPERIMENT_NAME = os.getenv("MLFLOW_EXPERIMENT_NAME", "Flatfoot")
    ...
    return {
        "files": {
            ...
            f"{model_key}_raw_file": p(
                root,
                "data/raw/ALL FEATURES OLDER - Pes Planus and Control JUNE 25.xlsx",
            ),
            ...
            f"{model_key}_shap_excel": first_existing_path([
                p(root, f"output-flatfoot/{DATASET_PREFIX}_SHAP_data_{model_file_label}.xlsx"),
                p(root, f"output-flatfoot/{DATASET_PREFIX}_SHAP_data.xlsx"),
                p(root, f"results/{DATASET_PREFIX}_SHAP_data_{model_file_label}.xlsx"),
            ]),
        },
        "folders": {
            f"{model_key}_shap_plots": first_existing_path([
                p(root, f"output-flatfoot/{shap_folder_name}"),
                p(root, f"output-flatfoot/{DATASET_PREFIX}_SHAP"),
...
MODEL_CONFIGS = [
    {
        ...
        "artifact_folder": "flatfoot_svm_files",
        "shap_artifact_folder": "svm_shap_plots",
        "run_name": "Flatfoot_2024_SVM_RBF_All_Files",
    },
    {
        "model_key": "xgboost",
        "model_type": "XGBoost",
        ...
        "artifact_folder": "flatfoot_xgboost_files",
        "shap_artifact_folder": "xgboost_shap_plots",
        "run_name": "Flatfoot_2024_XGBoost_All_Files",
    },
    {
        "model_key": "random_forest",
        ...
        "artifact_folder": "flatfoot_random_forest_files",
        "shap_artifact_folder": "random_forest_shap_plots",
        "run_name": "Flatfoot_2024_RandomForest_All_Files",
    },
    {
        "model_key": "mlp",
        "model_type": "MLP",
        ...
        "artifact_folder": "flatfoot_mlp_files",
        "shap_artifact_folder": "mlp_shap_plots",
        "run_name": "Flatfoot_2024_MLP_All_Files",
    },
    {
        "model_key": "catboost",
        "model_type": "CatBoost",
        ...
        "artifact_folder": "flatfoot_catboost_files",
        "shap_artifact_folder": "catboost_shap_plots",
        "run_name": "Flatfoot_2024_CatBoost_All_Files",
    },
    {
        "model_key": "lightgbm",
        "model_type": "LightGBM",
        ...
        "artifact_folder": "flatfoot_lightgbm_files",
        "shap_artifact_folder": "lightgbm_shap_plots",
        "run_name": "Flatfoot_2024_LightGBM_All_Files",
    },
]
...
def main():
    ...
    print("\nDone. Flatfoot MLflow logging finished.")
